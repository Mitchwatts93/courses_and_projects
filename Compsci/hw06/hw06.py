...
class VendingMachine:
    ...
    def restock(self, quantity):
        self.stock += quantity
        return 'Current {0} stock: {1}'.format(self.label, self.stock)
    ...
    def vend(self):
        if self.stock ==0:
            ...
            self.stock -= 1
            if change == 0:
                return 'Here is your {0}.'.format(self.label)
            else:
                return 'Here is your {0} and ${1} change.'.format(self.label, change)
